...
func file_protos_projectrol_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protos_projectrol_proto_msgTypes[69].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protos_projectrol_proto_msgTypes[70].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protos_projectrol_proto_msgTypes[71].Exporter = func(v interface{}, i int) interface{} {
